...
#     .read
#     .schema(full_schema)
#     .parquet(f"{ROOT}/my_code/my_practice/nested_schema/test")
# )
#
# transform_df = (
#     df_parq
...
#     .mode("overwrite")
#     .json(f"{ROOT}/my_code/my_practice/nested_schema/json_dir/")
# )
...
#     .option("multiline", True)
#     .schema(full_schema)
#     .json(f"{ROOT}/my_code/my_practice/nested_schema/json_dir/*.json")  # timestampFormat
# )
#
# print('df_json')
...
df_parq = (
    ...
    .read
    # .schema(full_schema)
    .parquet("/home/vladyslav_podrazhanskyi/tmp_test_container/5d454bef_0bd5_4974_8c12_00fd117d3580/iris_bi_fs_tpartner_func_enriched/*.parquet")
)
