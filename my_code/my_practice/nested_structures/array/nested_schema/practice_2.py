...
#     .option("header", True)
#     .schema(part_schema)
#     .csv(f"{ROOT}/my_code/my_practice/nested_schema/corrected_concur_report.csv")
# )
# #
# #
# print('df_csv')
...
#     .read
#     .schema(part_schema)
#     .json(f"{ROOT}/my_code/my_practice/nested_schema/json_dir/*.json")
# )
#
# print('df_json')
# df_json.show()
...
# df_csv_vert = csv_extractor("|", f'{ROOT}/my_code/my_practice/nested_schema/annex_sector_risk_iafa_vert.csv')
