...
#  expense_entries_list:
    ...
    # 	long
	# 	custom1: type,  value
	# 	custom10: code,  type,  value
	# 	custom2: code,  type,  value
	# 	custom3: type,  value
	# 	custom35: type,  value
	# 	custom5: type,  value
	...
	# 				allocation:
	#   				long,  long,  string
	#   				custom1: code,  type,  value (string*3)
	#   				custom2: code,  type,  value (string*3)
	#   				custom3: code,  type,  value (string*3)
	#   				custom4: code,  type,  value (string*3)
	#   				custom7: code,  type,  value (string*3)
	#   				custom8: code,  type,  value (string*3)
	#   				journalentrieslist:
	...
	#			custom10: code,  type,  value (string*3)
	#			custom2: code,  type,  value (string*3)
